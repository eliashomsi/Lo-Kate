...
public abstract class CameraActivity extends Activity
        implements OnImageAvailableListener, Camera.PreviewCallback, RecognitionListener {
    private static final Logger LOGGER = new Logger();

    private static final int PERMISSIONS_REQUEST = 1;
    public String output ="";
    public static boolean runningNav = false;
    ...
    public synchronized void onResume() {
        ...
        newTask.context = this.getApplicationContext();
        newTask.execute();
        bindService(new Intent(this, VoiceCommandService.class), mServiceConnection, mBindFlag);
    ...
    class SpeechRecog extends AsyncTask<Void, Integer, Boolean> {
        private SpeechRecognizer mSpeechRecognizer;
        private Intent speechIntent;
